...
1. Run `pwd` — confirm you are in the project the user wants to set up. If this is the codsworth-marketplace repo itself (cwd ends in `codsworth-marketplace`), STOP and ask the user which app to set up — this plugin is not meant to test itself.
